...
set(_exported_libraries "velodyne_rawdata;velodyne_cloud_types")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'velodyne_pointcloud' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND velodyne_pointcloud_LIBRARIES ${_cfg} "${_lib}")
